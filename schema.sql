...
CREATE TABLE IF NOT EXISTS katalog (
  ...
  year INT NOT NULL,
  pages INT NOT NULL,
  size VARCHAR(50) NOT NULL DEFAULT '14.8 x 21 cm',
...
INSERT INTO katalog (slug, title, author, isbn, year, pages, size, category, synopsis, coverBg, coverTextColor, coverImage, features, previewGallery) VALUES
(
